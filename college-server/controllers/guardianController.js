const Guardian = require("../models/guardianSchema");
module.exports = {

  // post

  addGuardianDetails: async (req, res) => {
  ...
  deleteGuardianDetails: async (req, res) => {
    try {
  ...
  editGuardianDetails: async (req, res) => {
    try {
  ...
  getidGuardianDetails: async (req, res) => {
